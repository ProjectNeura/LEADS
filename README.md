...
instrumentation and control system for electric vehicles. It is written in well-organized Python and C/C++ with impressive
...
```shell
pip install Pillow customtkinter keyboard pyserial gpiozero leads
```

`numpy` will be automatically installed with `leads`.

`Pillow`, `customtkinter`, `keyboard`, `pyserial`, and `gpiozero` are optional.
...
| `w_font_size_small`       | `int`  | Small font size                                                    | Main         | `8`           |
| `w_font_size_medium`      | `int`  | Medium font size                                                   | Main         | `16`          |
| `w_font_size_large`       | `int`  | Large font size                                                    | Main         | `32`          |
| `w_font_size_x_large`     | `int`  | Extra large font size                                              | Main         | `48`          |
