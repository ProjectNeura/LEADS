...
class DataContainer(Serializable, metaclass=_ABCMeta):
    def __init__(self, voltage: float, min_speed: float, mileage: float, longitude: float, latitude: float) -> None:
...
class SRWDataContainer(DataContainer):
    def __init__(self,
        ...
        super().__init__(voltage, min_speed, mileage, longitude, latitude)
